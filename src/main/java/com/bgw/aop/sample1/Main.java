...
import com.bgw.aop.common.FooService;
import com.bgw.aop.common.FooServiceImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // com.bgw.aop.sample1.SimplePojo
        System.out.println("proxyFactory.getTargetClass() = " + proxyFactory.getTargetClass());
        // SingletonTargetSource for target object [com.bgw.aop.sample1.SimplePojo@442d9b6e]
        System.out.println("proxyFactory.getTargetSource() = " + proxyFactory.getTargetSource());

        // [interface com.bgw.aop.sample1.Pojo]
        System.out.println("Arrays.asList(proxyFactory.getProxiedInterfaces()) = " + Arrays.asList(proxyFactory.getProxiedInterfaces()));
        // [org.springframework.aop.support.DefaultPointcutAdvisor: pointcut [Pointcut.TRUE]; advice [com.bgw.aop.sample1.Main$$Lambda$1/205797316@ee7d9f1]]
        ...
        // interface com.bgw.aop.common.FooService,
